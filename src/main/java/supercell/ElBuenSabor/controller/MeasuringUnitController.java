...
public class MeasuringUnitController {
    ...
    public ResponseEntity<Boolean> deleteMeasuringEntity(@PathVariable Long ID){
        return ResponseEntity.status(HttpStatus.OK).body(measuringUnitServiceImpl.deleteMeasuringUnit(ID));
    }
}
